...
public class EmailTemplateAddEditAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<EmailTemplateDTO> mList;
    Context mContext;

    public EmailTemplateAddEditAdpter(Context mContext, ArrayList<EmailTemplateDTO> mList) {
        this.mList = mList;
    ...
    public interface OnDropDownItemCallback{
        void onItemClicked(EmailTemplateDTO value);
        void onRemoveItemClicked(EmailTemplateDTO value);
    }
