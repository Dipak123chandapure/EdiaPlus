...
public class SMSDashboardToListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<StudentDTO> mList;

    public SMSDashboardToListAdapter(Context mContext, ArrayList<StudentDTO> mList) {
        this.mList = mList;
    }
