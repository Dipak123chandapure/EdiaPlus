...
public class SMSDashboardStudentListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<StudentDTO> mList;

    public SMSDashboardStudentListAdapter(Context mContext, ArrayList<StudentDTO> mList) {
        this.mList = mList;
    }
